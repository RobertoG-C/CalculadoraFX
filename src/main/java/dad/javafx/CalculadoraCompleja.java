...
public class CalculadoraCompleja extends Application {
	...
	private void onOperadorAction(String nv) {
		...
		case "+":
			...
			c.imaginarioProperty().bind(a.imaginarioProperty().add(b.imaginarioProperty()));

			break;
		case "-":
			c.realProperty().bind(a.realProperty().subtract(b.realProperty()));
			c.imaginarioProperty().bind(a.imaginarioProperty().subtract(b.imaginarioProperty()));

			break;
		case "*":
			c.realProperty().bind(a.realProperty().multiply(b.realProperty())
					.subtract(a.imaginarioProperty().multiply(b.imaginarioProperty())));
			c.imaginarioProperty().bind(a.realProperty().multiply(b.imaginarioProperty())
		...
		case "/":
			c.realProperty()
					.bind((a.realProperty().multiply(b.realProperty())
							.add(a.imaginarioProperty().multiply(b.imaginarioProperty())))
									.divide(b.realProperty().multiply(b.realProperty())
											.add(b.imaginarioProperty().multiply(b.imaginarioProperty()))));
			c.imaginarioProperty()
					.bind((a.imaginarioProperty().multiply(b.realProperty())
							.subtract(a.realProperty().multiply(b.imaginarioProperty())))
									.divide(b.realProperty().multiply(b.realProperty())
											.add(b.imaginarioProperty().multiply(b.imaginarioProperty()))));
			break;
		}
